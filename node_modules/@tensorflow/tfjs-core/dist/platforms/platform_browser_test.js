...
var platform_browser_1 = require("./platform_browser");
jasmine_util_1.describeWithFlags('PlatformBrowser', jasmine_util_1.BROWSER_ENVS, function () { return __awaiter(_this, void 0, void 0, function () {
    var _this = this;
    return __generator(this, function (_a) {
        it('fetch calls window.fetch', function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        platform = new platform_browser_1.PlatformBrowser();
                        return [4 /*yield*/, platform.fetch('test/url', { method: 'GET' })];
                    case 1:
                        _a.sent();
        ...
        it('now should use performance.now', function () { return __awaiter(_this, void 0, void 0, function () {
            var platform, ms;
            return __generator(this, function (_a) {
                platform = new platform_browser_1.PlatformBrowser();
                ms = 1234567;
        ...
        it('encodeUTF8 single string', function () {
            var platform = new platform_browser_1.PlatformBrowser();
        ...
        it('decode single string', function () {
            var platform = new platform_browser_1.PlatformBrowser();
            var s = platform.decode(new Uint8Array([104, 101, 108, 108, 111]), 'utf-8');
            expect(s.length).toBe(5);
            expect(s).toEqual('hello');
        });
        it('decode two strings delimited', function () {
            var platform = new platform_browser_1.PlatformBrowser();
            var s = platform.decode(new Uint8Array([104, 101, 108, 108, 111, 0, 119, 111, 114, 108, 100]), 'utf-8');
            expect(s.length).toBe(11);
            expect(s).toEqual('hello\x00world');
        });
        it('decode cyrillic', function () {
            var platform = new platform_browser_1.PlatformBrowser();
            var s = platform.decode(new Uint8Array([208, 151, 208, 180, 209, 128, 208, 176, 208, 178, 208, 190]), 'utf-8');
...
//# sourceMappingURL=platform_browser_test.js.map