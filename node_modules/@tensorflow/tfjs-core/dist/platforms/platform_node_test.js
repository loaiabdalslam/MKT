...
var platform_node = require("./platform_node");
var platform_node_1 = require("./platform_node");
jasmine_util_1.describeWithFlags('PlatformNode', jasmine_util_1.NODE_ENVS, function () {
    it('fetch should use global.fetch if defined', function () { return __awaiter(_this, void 0, void 0, function () {
        var globalFetch, platform;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    globalFetch = environment_1.ENV.global.fetch;
                    spyOn(environment_1.ENV.global, 'fetch').and.returnValue(function () { });
                    platform = new platform_node_1.PlatformNode();
                    return [4 /*yield*/, platform.fetch('test/url', { method: 'GET' })];
                case 1:
                    _a.sent();
                    expect(environment_1.ENV.global.fetch).toHaveBeenCalledWith('test/url', { method: 'GET' });
                    environment_1.ENV.global.fetch = globalFetch;
                    return [2 /*return*/];
            }
        });
    }); });
    it('fetch should use node-fetch with ENV.global.fetch is null', function () { return __awaiter(_this, void 0, void 0, function () {
        var globalFetch, platform, savedFetch, testFetch;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    globalFetch = environment_1.ENV.global.fetch;
                    environment_1.ENV.global.fetch = null;
                    platform = new platform_node_1.PlatformNode();
                    savedFetch = platform_node.systemFetch;
                    // Null out the system fetch so we force it to require node-fetch.
                    // @ts-ignore
                    platform_node.systemFetch = null;
                    testFetch = { fetch: function (url, init) { } };
                    // Mock the actual fetch call.
                    spyOn(testFetch, 'fetch').and.returnValue(function () { });
                    // Mock the import to override the real require of node-fetch.
                    spyOn(platform_node.getNodeFetch, 'importFetch')
                        .and.callFake(function () { return function (url, init) {
    ...
    it('now should use process.hrtime', function () { return __awaiter(_this, void 0, void 0, function () {
        var time;
        return __generator(this, function (_a) {
            time = [100, 200];
            spyOn(process, 'hrtime').and.returnValue(time);
            expect(environment_1.ENV.platform.now()).toEqual(time[0] * 1000 + time[1] / 1000000);
            return [2 /*return*/];
        });
    }); });
...
//# sourceMappingURL=platform_node_test.js.map