...
jasmine_util_1.describeWithFlags('dropout', jasmine_util_1.ALL_ENVS, function () {
    ...
    var seed = 23;
    var _loop_1 = function (dropoutLevel) {
        it("Level = " + dropoutLevel, function () { return __awaiter(_this, void 0, void 0, function () {
            var x, y, xValue, yValue, nKept, i, numel;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        x = tf.range(1, 21).reshape([10, 2]);
                        y = tf.dropout(x, tf.scalar(dropoutLevel), null, seed);
